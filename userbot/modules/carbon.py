...
async def carbon_api(e):
 if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
   ...
   CARBON = 'https://carbon.now.sh/?bg=rgba(239%252C40%252C44%252C1)&t=one-light&wt=sharp&l=python&ds=true&dsyoff=20px&dsblur=68px&wc=true&wa=true&pv=0px&ph=0px&ln=false&fm=Hack&fs=14px&lh=110%2525&si=false&es=2x&wm=false&code={code}'
